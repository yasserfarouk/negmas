...
def nonmonotonic_minmax(input: Iterable, f: Callable[[Any], float]) -> tuple[float, float]:
...
def nonmonotonic_multi_minmax(input: Iterable[Iterable], f: Callable[[Any], float]) -> tuple[float, float]:
...
def monotonic_minmax(input: HasMinMax, f: Callable[[Any], float]) -> tuple[float, float]:
...
def monotonic_multi_minmax(input: Iterable[HasMinMax], f: Callable[[Any], float]) -> tuple[float, float]:
