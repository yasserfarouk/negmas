"""Implements Nested Negotiations Mechanism"""
...
__all__ = ["ChainNegotiationsMechanism", "ChainNegotiator"]

Offer = namedtuple("Offer", ["outcome", "left", "temp"])
...
class ChainNegotiationsMechanism(Mechanism):
    ...
    def round(self) -> MechanismRoundResult:
        ...
        if response == ResponseType.ACCEPT_OFFER:
            ...
            self.__last_proposer_index = self.__last_proposer_index
            self._update_next()
            return MechanismRoundResult()
