...
class Controller(Rational, Generic[TNMI, TState, TControlledNegotiator]):
    """
    ...
    def __init__(
        self,
        default_negotiator_type: str | TControlledNegotiator | None = None,
    ...
    @property
    def states(self) -> dict[str, TState]:
        """
    ...
    #     def _on_negotiation_start(self, negotiator_id: str, state: TState) -> None:
    #         """
    #         A call back called at each negotiation start dirctly by the mechanism
    #
    #         Args:
    #             negotiator_id: The negotiator ID
    #             state: `TState` giving current state of the negotiation.
    #
    #         """
    #         negotiator, cntxt = self._negotiators.get(negotiator_id, (None, None))
    #         if negotiator is None:
    ...
    def on_negotiation_start(self, negotiator_id: str, state: TState) -> None:
        """
