...
import negotiator.boaframework.offeringstrategy.other.Random_Offering;
import negotiator.boaframework.omstrategy.NullStrategy;

import java.util.HashMap;

@SuppressWarnings("deprecation")
public class RandomBOAagent extends BOAagentBilateral {
	...
	public void agentSetup() {
		...
		offeringStrategy = new Random_Offering();
