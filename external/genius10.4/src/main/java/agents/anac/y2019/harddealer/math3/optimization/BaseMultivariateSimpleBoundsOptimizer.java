...
public interface BaseMultivariateSimpleBoundsOptimizer<FUNC extends MultivariateFunction>
     ...
     * @throws agents.anac.y2019.harddealer.math3.exception.NumberIsTooSmallException if any
     * of the initial values is less than its lower bound.
     * @throws agents.anac.y2019.harddealer.math3.exception.NumberIsTooLargeException if any
