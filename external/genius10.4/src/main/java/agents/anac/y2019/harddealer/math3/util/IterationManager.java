...
public class IterationManager {
     ...
     * @throws agents.anac.y2019.harddealer.math3.exception.NullArgumentException if {@code callBack} is {@code null}
     * @since 3.1
     * @deprecated as of 3.6, replaced with {@link #IterationManager(int,
     * agents.anac.y2019.harddealer.math3.util.IntegerSequence.Incrementor.MaxCountExceededCallback)}
     */
    @Deprecated
    public IterationManager(final int maxIterations,
