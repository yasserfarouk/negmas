...
package agents.anac.y2019.harddealer.math3.ode.events;
...
public interface EventHandler  {
    ...
    enum Action {
         ...
         * agents.anac.y2019.harddealer.math3.ode.FirstOrderDifferentialEquations#computeDerivatives}
         * method).</p>
         */
        RESET_DERIVATIVES,
   ...
   * otherwise {@link agents.anac.y2019.harddealer.math3.exception.NoBracketingException
   ...
   * agents.anac.y2019.harddealer.math3.ode.FirstOrderDifferentialEquations
   ...
   *   agents.anac.y2019.harddealer.math3.ode.sampling.StepHandler#handleStep handleStep}
   ...
   * agents.anac.y2019.harddealer.math3.ode.sampling.StepHandler StepHandler} method {@link
   * agents.anac.y2019.harddealer.math3.ode.sampling.StepHandler#handleStep(
   * agents.anac.y2019.harddealer.math3.ode.sampling.StepInterpolator, boolean)
   ...
   * agents.anac.y2019.harddealer.math3.ode.sampling.StepNormalizer StepNormalizer}
   * does for example), user code called by this method and user
   * code called by step handlers may experience apparently out of order values
   * of the independent time variable. As an example, if the same user object
   * implements both this {@link EventHandler EventHandler} interface and the
   * {@link agents.anac.y2019.harddealer.math3.ode.sampling.FixedStepHandler FixedStepHandler}
   ...
   * agents.anac.y2019.harddealer.math3.ode.sampling.StepHandler variable step handlers} and
   * to the size of the fixed step for {@link
   * agents.anac.y2019.harddealer.math3.ode.sampling.FixedStepHandler fixed step handlers}.</p>
