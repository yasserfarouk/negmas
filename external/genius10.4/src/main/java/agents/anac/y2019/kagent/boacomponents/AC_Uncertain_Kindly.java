package agents.anac.y2019.kagent.boacomponents;
 ...
 * Discount is ignored.
 */
public class AC_Uncertain_Kindly extends AcceptanceStrategy {

	private int loan;
	
	public AC_Uncertain_Kindly() {
		super();
		this.loan = 0;
	}
	...
	public Actions determineAcceptability() {
		...
		if (userModel != null) {
			...
			if (otherLastUtil >= 0.95 * myLastUtil && loan < 10) {
				System.err.print("loan plus");
				loan += 1;
				return Actions.Accept;
			} else if (otherLastUtil >= 1.05 * myLastUtil) {
				System.err.print("loan minus");
				loan -= 1;
				return Actions.Accept;
			}
		}
