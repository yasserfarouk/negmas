package agents.anac.y2019.kagent;
...
import agents.anac.y2019.kagent.boacomponents.AC_Uncertain_Kindly;
...
import agents.anac.y2019.kagent.boacomponents.TimeDependent_Offering;
...
public class KAgent extends BoaParty 
{
	@Override
	public void init(NegotiationInfo info) 
	{
		// The choice for each component is made here
		AcceptanceStrategy 	ac  = new AC_Uncertain_Kindly();
	...
	{
		return "Boa Party with Uncertainity(copy)";
	}
