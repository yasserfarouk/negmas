 ...
 */
package agents.anac.y2019.harddealer.math3.geometry.euclidean.threed;
...
import agents.anac.y2019.harddealer.math3.geometry.Point;
import agents.anac.y2019.harddealer.math3.geometry.euclidean.oned.Euclidean1D;
import agents.anac.y2019.harddealer.math3.geometry.euclidean.twod.Euclidean2D;
import agents.anac.y2019.harddealer.math3.geometry.euclidean.twod.PolygonsSet;
import agents.anac.y2019.harddealer.math3.geometry.euclidean.twod.SubLine;
import agents.anac.y2019.harddealer.math3.geometry.euclidean.twod.Vector2D;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.AbstractRegion;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.BSPTree;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.BSPTreeVisitor;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.BoundaryAttribute;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.Hyperplane;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.Region;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.RegionFactory;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.SubHyperplane;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.Transform;
    ...
    private static class RotationTransform implements Transform<Euclidean3D, Euclidean2D> {
        ...
        public SubHyperplane<Euclidean2D> apply(final SubHyperplane<Euclidean2D> sub,
            ...
            if (original != cachedOriginal) {
                ...
                cachedTransform =
                        agents.anac.y2019.harddealer.math3.geometry.euclidean.twod.Line.getTransform(tP10.getX() - tP00.getX(),
                                                                                           tP10.getY() - tP00.getY(),
                                                                                           tP01.getX() - tP00.getX(),
                                                                                           tP01.getY() - tP00.getY(),
                                                                                           tP00.getX(),
    ...
    private static class TranslationTransform implements Transform<Euclidean3D, Euclidean2D> {
        ...
        public SubHyperplane<Euclidean2D> apply(final SubHyperplane<Euclidean2D> sub,
            ...
            if (original != cachedOriginal) {
                ...
                cachedOriginal  = (Plane) original;
                cachedTransform =
                        agents.anac.y2019.harddealer.math3.geometry.euclidean.twod.Line.getTransform(1, 0, 0, 1,
                                                                                           shift.getX(),
                                                                                           shift.getY());
