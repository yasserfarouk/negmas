...
package agents.anac.y2019.harddealer.math3.ml.neuralnet.sofm;

import agents.anac.y2019.harddealer.math3.ml.neuralnet.sofm.util.ExponentialDecayFunction;
import agents.anac.y2019.harddealer.math3.ml.neuralnet.sofm.util.QuasiSigmoidDecayFunction;
...
public class LearningFactorFunctionFactory {
     ...
     * @throws agents.anac.y2019.harddealer.math3.exception.OutOfRangeException
     * if {@code initValue <= 0} or {@code initValue > 1}.
     * @throws agents.anac.y2019.harddealer.math3.exception.NotStrictlyPositiveException
     * if {@code valueAtNumCall <= 0}.
     * @throws agents.anac.y2019.harddealer.math3.exception.NumberIsTooLargeException
