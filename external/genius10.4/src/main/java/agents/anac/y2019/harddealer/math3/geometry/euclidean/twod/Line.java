...
import agents.anac.y2019.harddealer.math3.geometry.Vector;
...
import agents.anac.y2019.harddealer.math3.geometry.euclidean.oned.OrientedPoint;
import agents.anac.y2019.harddealer.math3.geometry.euclidean.oned.Vector1D;
import agents.anac.y2019.harddealer.math3.geometry.partitioning.Embedding;
...
public class Line implements Hyperplane<Euclidean2D>, Embedding<Euclidean2D, Euclidean1D> {
     ...
     * agents.anac.y2019.harddealer.math3.geometry.euclidean.threed.Line class.</p>
     *
     * @param p to check
    ...
    /** Get a {@link agents.anac.y2019.harddealer.math3.geometry.partitioning.Transform
     * Transform} embedding an affine transform.
     * @param transform affine transform to embed (must be inversible
     * otherwise the {@link
     * agents.anac.y2019.harddealer.math3.geometry.partitioning.Transform#apply(Hyperplane)
     * apply(Hyperplane)} method would work only for some lines, and
     * fail for other ones)
     * @return a new transform that can be applied to either {@link
     * Vector2D Vector2D}, {@link Line Line} or {@link
     * agents.anac.y2019.harddealer.math3.geometry.partitioning.SubHyperplane
