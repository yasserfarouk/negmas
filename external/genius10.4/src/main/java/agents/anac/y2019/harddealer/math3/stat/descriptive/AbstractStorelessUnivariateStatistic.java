...
public abstract class AbstractStorelessUnivariateStatistic
     ...
     * @see agents.anac.y2019.harddealer.math3.stat.descriptive.UnivariateStatistic#evaluate(double[])
     */
    @Override
     ...
     * @see agents.anac.y2019.harddealer.math3.stat.descriptive.UnivariateStatistic#evaluate(double[], int, int)
     */
    @Override
     ...
     * @throws MathIllegalArgumentException if values is null
     * @see agents.anac.y2019.harddealer.math3.stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[])
     */
     ...
     * @throws MathIllegalArgumentException if values is null
     * @see agents.anac.y2019.harddealer.math3.stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[], int, int)
     */
