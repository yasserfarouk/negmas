...
public class Combinations implements Iterable<int[]> {
   ...
   /**
     ...
     * @throws agents.anac.y2019.harddealer.math3.exception.NotPositiveException if {@code n < 0}.
     * @throws agents.anac.y2019.harddealer.math3.exception.NumberIsTooLargeException if {@code k > n}.
     */
