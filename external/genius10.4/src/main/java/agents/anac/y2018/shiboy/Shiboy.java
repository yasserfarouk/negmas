package agents.anac.y2018.shiboy;

import java.util.List;

import agents.anac.y2018.shiboy.etc.BidSearch;
import agents.anac.y2018.shiboy.etc.NegoHistory;
import agents.anac.y2018.shiboy.etc.NegoStats;
import agents.anac.y2018.shiboy.etc.NegoStrategy;
 ...
 */
public class Shiboy extends AbstractNegotiationParty {
    ...
    public Action chooseAction(List<Class<? extends Action>> validActions) {
        ...
        try {
			...
			int stopTime = rand.nextInt(1000);
