...
public class OpponentModel
{
  ...
  public Domain getDomain() {
    return fDomain; }
  Double minUtility = null; Double maxUtility = null;
  public double getExpectedUtility(Bid pBid) throws Exception { return -1.0D; }
  ...
  {}
  public double getExpectedWeight(int pIssueNumber) { return 0.0D; }
  
  public boolean haveSeenBefore(Bid pBid) { for (Bid tmpBid : fBiddingHistory) {
  ...
  protected void findMinMaxUtility() throws Exception {
    ...
    minUtility = Double.valueOf(1.0D);maxUtility = Double.valueOf(0.0D);
    ...
    while (biditer.hasNext())
    {
      ...
      if (minUtility.doubleValue() > u) minUtility = Double.valueOf(u);
      if (maxUtility.doubleValue() < u) maxUtility = Double.valueOf(u);
    }
  }
