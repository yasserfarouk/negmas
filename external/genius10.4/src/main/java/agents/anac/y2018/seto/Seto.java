package agents.anac.y2018.seto;
import java.util.List;

import agents.anac.y2018.seto.etc.BidSearch;
import agents.anac.y2018.seto.etc.NegoHistory;
import agents.anac.y2018.seto.etc.NegoStats;
import agents.anac.y2018.seto.etc.NegoStrategy;
 ...
 */
public class Seto extends AbstractNegotiationParty {
    private NegotiationInfo info;
    private Bid lastReceivedBid = null;
    private Bid previousBid     = null;
    private Bid farstBid        = null;
    ...
    public Action chooseAction(List<Class<? extends Action>> validActions) {
        ...
        if(farstBid == null) {
        		if(lastReceivedBid != null) {
        			farstBid = lastReceivedBid;
        			negoStrategy.alpha = 4*Math.pow(info.getUtilitySpace().getUtility(farstBid),0.5)+0.5;
        		}
        }
