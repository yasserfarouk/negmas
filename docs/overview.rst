...
`World <http://negmas.readthedocs.io/en/latest/api/negmas.situated.World.html>`__
...
`Agent <http://negmas.readthedocs.io/en/latest/api/negmas.situated.Agent.html>`__
...
`here <http://negmas.readthedocs.io/en/latest/api/negmas.situated.AgentWorldInterface.html>`__.
...
`here <http://negmas.readthedocs.io/en/latest/api/negmas.common.NegotiatorMechanismInterface.html>`__.
...
`overview <http://negmas.readthedocs.io/en/latest/overview.html>`__ and
`tutorials <http://negmas.readthedocs.io/en/latest/tutorials.html>`__ for more
details. NegMAS also provides some basic **SAONegotiator**\ s for the
**SAOMechanism** (Check the class diagram
`here <http://negmas.readthedocs.io/en/latest/modules/sao.html>`__). Moreover,
you can access almost all `Genius <http://ii.tudelft.nl/genius/>`__
agents using NegMAS’s
`GeniusNegotiator <http://negmas.readthedocs.io/en/latest/api/negmas.genius.GeniusNegotiator.html>`__
