...
.. code:: python
       ...
       def join(
           self, x: "Agent", ufun: UtilityFunction = None, breach_prob: float = None, **kwargs
       ):
           """Define the ufun and breach-probability for each agent"""
           super().join(x, **kwargs)
           ...
...
.. code:: python
       ...
       def on_contract_signed(self, contract):
           ...
       ...
       def order_contracts_for_execution(self, contracts):
           ...


       def start_contract_execution(self, contract):
           ...


       def complete_contract_execution(self, contract, breaches, resolution):
           ...


       def delete_executed_contracts(self):
           ...


       def contract_record(self, contract):
           ...


       def breach_record(self, breach):
           ...


       def contract_size(self, contract):
           ...
...
.. code:: python
       ...
       def on_contract_breached(self, contract, breaches):
           ...
