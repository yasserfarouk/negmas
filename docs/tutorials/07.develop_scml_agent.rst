    ...
    <table border="1" class="dataframe">
      ...
      <tbody>
        <tr>
          ...
          <td>0.012450</td>
          <td>/Users/yasser/code/projects/negmas/notebooks/t...</td>
          <td>20190422-062515kb7K00001</td>
        </tr>
        <tr>
          <th>1</th>
          <td>my@1_1</td>
...
factory manager getting an average profit of *2%* compared with the
...
*1.56e-7 << 0.05*. If you try running this this tournament for less than
*n\_steps*, the greedy factory manager will most likely lose money. In
the actual league, we will run each world simulation between *50* and
*100* steps (more toward the later).
