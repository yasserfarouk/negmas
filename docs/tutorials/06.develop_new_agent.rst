...
.. image:: 06.develop_new_agent_files/06.develop_new_agent_7_0.png
...
.. code:: ipython3
    ...
    fig.update_layout(xaxis_title="Simulation Step", yaxis_title="Activity Level ($)\nTotal Welfare")
    fig.show()
...
.. code:: ipython3
    ...
    import plotly.graph_objects as go
    fig = go.Figure()
    fig.add_trace(go.Scatter(y=world.stats["n_contracts_signed"], mode='lines', name="Signed Contracts"))
    fig.add_trace(go.Scatter(y=world.stats["n_contracts_executed"], mode='lines', name="Executed Contracts"))
...
.. code:: ipython3
    ...
    for name in snames:
        fig.add_trace(go.Scatter(y=np.asarray(world.stats[f"total_utility_{name}"]), mode='lines', name=name))
    fig.update_layout(xaxis_title="Simulation Step", yaxis_title="Player Total Utility", legend=dict(x=0, y=0))
    fig.show()
