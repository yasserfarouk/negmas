...
`here <https://yasserfarouk.github.io/files/geniusbridge.jar>`__ and
copy it to a folder ``files`` under ``negmas`` in your home directory.
For Linux and macOS, you can just run:
...
a scenario from secondary storage.
