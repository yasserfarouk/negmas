...
class TestSingletonOutcomeSpace:
    ...
    def test_singleton_os_from_outcome(self):
        """Test creating SingletonOutcomeSpace from outcome."""
        outcome = (1, "a", 3.5)
        os = SingletonOutcomeSpace.from_outcome(outcome)
    ...
    def test_singleton_os_with_issue_names(self):
        ...
        outcome = (1, 2, 3)
        os = SingletonOutcomeSpace.from_outcome(
            outcome, issue_names=["x", "y", "z"], name="test_os"
        )

        assert os.outcome == outcome
        assert os.issue_names == ["x", "y", "z"]
    ...
    def test_singleton_os_auto_issue_names(self):
        ...
        assert os.issue_names == ["issue00", "issue01"]
    ...
    def test_singleton_os_is_discrete(self):
        ...
        os = SingletonOutcomeSpace.from_outcome((1, 2))
    ...
    def test_singleton_os_mismatched_names_raises(self):
        ...
        with pytest.raises(ValueError):
            SingletonOutcomeSpace.from_outcome((1, 2, 3), issue_names=["a", "b"])
...
class TestContainsOs:
    ...
    def test_cartesian_contains_singleton(self):
        ...
        singleton = SingletonOutcomeSpace.from_outcome((3, 5), issue_names=["a", "b"])
    ...
    def test_cartesian_does_not_contain_invalid_singleton(self):
        ...
        singleton = SingletonOutcomeSpace.from_outcome((10, 10), issue_names=["a", "b"])
    ...
    def test_singleton_contains_singleton(self):
        ...
        s1 = SingletonOutcomeSpace.from_outcome((1, 2))
        s2 = SingletonOutcomeSpace.from_outcome((1, 2))
    ...
    def test_singleton_does_not_contain_different_singleton(self):
        ...
        s1 = SingletonOutcomeSpace.from_outcome((1, 2))
        s2 = SingletonOutcomeSpace.from_outcome((1, 3))
    ...
    def test_enumerating_contains_singleton(self):
        ...
        singleton = SingletonOutcomeSpace.from_outcome((3, 4))
...
class TestSetOperationsUnion:
    ...
    def test_singleton_union_singleton(self):
        ...
        s1 = SingletonOutcomeSpace.from_outcome((1,))
        s2 = SingletonOutcomeSpace.from_outcome((2,))
    ...
    def test_singleton_union_same(self):
        ...
        s1 = SingletonOutcomeSpace.from_outcome((1,))
        s2 = SingletonOutcomeSpace.from_outcome((1,))
    ...
    def test_cartesian_union_singleton(self):
        ...
        singleton = SingletonOutcomeSpace.from_outcome((5,), issue_names=["a"])
...
class TestSetOperationsIntersection:
    ...
    def test_singleton_intersection_non_containing_space(self):
        ...
        singleton = SingletonOutcomeSpace.from_outcome((10,), issue_names=["a"])
...
class TestSetOperationsDifference:
    ...
    def test_singleton_difference_containing_space(self):
        ...
        os = make_os(issues=[make_issue(5, "a")])  # 0-4
        singleton = SingletonOutcomeSpace.from_outcome((2,), issue_names=["a"])
    ...
    def test_singleton_difference_from_itself(self):
        ...
        s = SingletonOutcomeSpace.from_outcome((1,))
...
class TestMixedOperations:
    ...
    def test_chain_operations(self):
        ...
        s = SingletonOutcomeSpace.from_outcome((2,), issue_names=["a"])
...
class TestMultiIssueSpaces:
    ...
    def test_two_issue_singleton(self):
        ...
        outcome = (1, "a")
        os = SingletonOutcomeSpace.from_outcome(outcome, issue_names=["num", "char"])
    ...
    def test_two_issue_union(self):
        ...
        s = SingletonOutcomeSpace.from_outcome((5, "z"), issue_names=["a", "b"])
    ...
    def test_two_issue_difference(self):
        ...
        s = SingletonOutcomeSpace.from_outcome((0, 0), issue_names=["a", "b"])
...
class TestContainmentOperator:
    ...
    def test_outcome_in_singleton(self):
        ...
        s = SingletonOutcomeSpace.from_outcome((1, 2))
        assert (1, 2) in s
        assert (1, 3) not in s
    ...
    def test_singleton_in_cartesian(self):
        ...
        os = make_os(issues=[make_issue(10, "a")])
        s = SingletonOutcomeSpace.from_outcome((5,), issue_names=["a"])
...
class TestEdgeCases:
    ...
    def test_singleton_os_repr_and_str(self):
        ...
        os = SingletonOutcomeSpace.from_outcome((1, 2), name="test")
        repr_str = repr(os)
        str_str = str(os)
