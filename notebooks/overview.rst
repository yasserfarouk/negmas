...
.. parsed-literal::
    ...
    [['not to be',
      '20200410H1051371128255BuDQfJ7to be20200410H105137112861naq3MRdO'],
     [8, 11],
...
.. parsed-literal::
    ...
    MyOutcome(problem='not to be', price=0.8008428867830056, quantity=1)
    MyOutcome(problem='not to be', price=2.739434518014515, quantity=0)
    MyOutcome(problem='to be', price=2.671357705227991, quantity=2)
    MyOutcome(problem='to be', price=1.6466587932888777, quantity=0)
    MyOutcome(problem='not to be', price=1.8045415520296821, quantity=4)
